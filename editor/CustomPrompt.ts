...
export class CustomPrompt implements Prompt {
    ...
    private readonly _colorMenu: HTMLSelectElement = select({ style: "width: 100%;" },
			...
			option({ selected: false, disabled: true, hidden: false }, "Pitch Backgrounds"),

			option({ value: "--pitch-background" }, "Pitch Background"),
			option({ value: "--tonic" }, "Tonic"),
			option({ value: "--pitch1-background" }, "1st Pitch Background [!]"),
			option({ value: "--pitch2-background" }, "2nd Pitch Background [!]"),
			option({ value: "--pitch3-background" }, "3rd Pitch Background [!]"),
			option({ value: "--third-note" }, "Third note"),
			option({ value: "--pitch5-background" }, "5th Pitch Background [!]"),
			option({ value: "--pitch6-background" }, "6th Pitch Background [!]"),
			option({ value: "--fifth-note" }, "Fifth note"),
			option({ value: "--pitch8-background" }, "8th Pitch Background [!]"),
			option({ value: "--pitch9-background" }, "9th Pitch Background [!]"),
			option({ value: "--pitch10-background" }, "10th Pitch Background [!]"),
			option({ value: "--pitch11-background" }, "11th Pitch Background [!]"),
			...
			option({ value: "--empty-sample-bar" }, "Empty Sample Bar"),
			option({ value: "--octave-scrollbar" }, "Octave Scrollbar"),
			option({ value: "--scrollbar-color" }, "Primary Scrollbar Color"),
			option({ value: "--scrollbar-background" }, "Secondary Scrollbar Color"),
	/*
